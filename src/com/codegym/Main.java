        ...
        do {
            ...
            switch (choice) {
                ...
                case 2: {
                    ...
                    System.out.println("Nhập vị trí muốn thêm hộ dân: ");
                    int index = scanner.nextInt();
                    if (index - 1 < 0 || index - 1 > famillyMangement.famillies.length) {
                        System.out.println("Vị trí không hợp lệ");
                    } else {
                        Familly newFamilly = inputFamillyInfo();
                        famillyMangement.addNewFamilly(index - 1, newFamilly);
                    }
                    break;
                }
                case 3: {
                ...
                case 4: {
                    ...
                    if (index - 1 < 0 || index - 1 >= famillyMangement.famillies.length) {
                        ...
                        Familly newFamilly = inputFamillyInfo();
                        famillyMangement.updateFamilly(index, newFamilly);
                    }
                    break;
                }
                case 5: {
